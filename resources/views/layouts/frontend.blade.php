...
<html lang="zxx">
  <head>
    <meta charset="UTF-8" />
    <meta name="description" content="healtKUY" />
    <meta name="keywords" content="healt, unica, creative, html" />
  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> hello@healthkuy.com</li>
          <li>Dukung Gaya Hidup Sehatmu – Pengiriman Cepat dan Gratis!</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <div class="header__top__left">
                <ul>
                  <li><i class="fa fa-envelope"></i>hello@healthkuy.com</li>
                  <li>Dukung Gaya Hidup Sehat – Pengiriman Cepat dan Gratis di Jabodetabek!</li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6 col-md-6">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address: jln.Gatot Subroto, Medan Helvetia, Indonesia</li>
                <li>Phone: +62 812 6007 7811</li>
                <li>Email: healtkuy@gmail.com</li>
              </ul>
            </div>
          </div>
            ...
            <div class="footer__copyright">
              <div class="footer__copyright__text">
                <p>
                  ...
                  All rights reserved | Hidup Sehat Dimulai dari Sini
                  <i class="fa fa-heart" aria-hidden="true"></i> by
                  <a href="https://colorlib.com" target="_blank">healtKUY</a>
                  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
              </div>
